...
<img src="popup.png?__inline=true" title="" alt=""  style="width:25%; height:25%" />
...
<img style="width:50%; height:50%" title="Dashboard Data Visualizations" alt="Fully branded registration form" src="dashboard.png?__inline=true" />
